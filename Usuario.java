...
public class Usuario {
    ...
    public String getN_Seguridad_Social() { return n_Seguridad_Social; }
    public void setN_Seguridad_Social(String n_Seguridad_Social) { this.n_Seguridad_Social = n_Seguridad_Social; }
    
    public Prestamo registrarPrestamo(Ejemplar ejemplar) {
        if (prestamosActivos.size() >= 3) {
            throw new IllegalStateException("Límite de 3 préstamos activos");
        }
        Prestamo prestamo = new Prestamo(cod_Usuario);
